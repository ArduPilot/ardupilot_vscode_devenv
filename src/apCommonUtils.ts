 ...
 * Non-vehicle targets like bootloaders, and iofirmware do not need upload tasks.
 *
...
export function isVehicleTarget(target: string): boolean {
	...
	const vehicleTargets = ['copter', 'plane', 'rover', 'sub', 'blimp', 'heli', 'antennatracker', 'AP_Periph'];
